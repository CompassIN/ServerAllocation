...
#       echo $Gen_Blade
        echo "$Gen_name|$Gen_IP|7891|Loc1|/home/netstorm/$Gen_Blade|Internal|$con_ip|$con_blade|/home/netstorm/$con_blade|NETCLOUD|NA|NA|NA|NA|NA|NA|NA|NA|NA|NA" >> /etc/.netcloud/$input
